  ...
  return (
    <div className="flex-1 mx-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {/* Total Income Card */}
        <Card className="overflow-hidden border-1 border-l-4 border-emerald-500">
        ...
        {/* Total Expenses Card */}
        <Card className="overflow-hidden border-1 border-l-4 border-rose-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-muted/20">
        ...
        {/* Net Savings Card */}
        <Card className="overflow-hidden border-1 border-l-4 border-purple-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-muted/20">
